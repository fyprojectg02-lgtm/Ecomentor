...
export default function LearningPathGenerator({ userId }) {
    ...
    const fetchOrGeneratePaths = async (selectedInterests) => {
        ...
        try {
            ...
            console.log("🤖 No existing paths found, generating new ones with AI");
            await generatePathsWithAI(selectedInterests);
        } catch (err) {
            console.error("❌ Error in fetchOrGeneratePaths:", err);
            setIsGenerating(false);
        }
    };
    ...
    const generatePathsWithAI = async (selectedInterests) => {
        try {
            console.log("🚀 Calling AI API to generate learning paths...");
            ...
            console.log("✅ AI generated paths successfully:", data.learningPaths?.length || 0, "paths");
                ...
                <p className="text-sm text-gray-400 mb-4">
                    {educationLevel && (
                        <span className="text-emerald-400">
                            ✨ Auto-selected topics for {educationLevel} students.
                        </span>
